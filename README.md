...
- **Runtime interpreter** – The `internal/runtime` package evaluates Selene programs with lexical scoping, immutable/mutable bindings, first-class functions, arrays, objects, arithmetic, comparisons, pattern matching, and a small standard library (`print`).
