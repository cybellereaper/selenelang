...
- **Project metadata** – The repository includes a `selene.toml` manifest that describes the project entry point, documentation roots, and example directories for tooling integrations.
...
selene.toml        Project manifest for tooling metadata
```
