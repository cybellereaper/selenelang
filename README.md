...
- **CLI utility** – The `cmd/selene` binary can execute Selene scripts, dump the raw token stream, scaffold new workspaces, and manage vendored dependencies with secure checksum verification.
